...
export const METRIC_LABELS: Record<string, string> = {
  ...
  content_ctr: "Feed CTR",
  impressions_total: "Impressions",
  video_starts: "Video starts",
  video_completes: "Video completes",
  video_completion_rate: "Video completion",
  video_skip_rate: "Video skip rate",
  route_starts: "Route starts",
  route_completes: "Route completes",
  route_completion_rate: "Route completion",
  place_commerce_actions: "Local commerce actions",
  place_directions: "Directions taps",
  place_calls: "Place calls",
  place_website_clicks: "Website taps",
  place_map_opens: "Map opens",
  place_commerce_rate: "Local intent rate",
  push_opens: "Push opens",
  deep_link_opens: "Deep link opens",
  acquisition_opens: "Acquisition opens",
  engagement_actions: "Engagement actions",
  engagement_rate_estimate: "Engagement rate",
  ...
  estimated_new_anonymous_ids: "New anonymous users",
  estimated_returning_anonymous_ids: "Returning anonymous users",
  estimated_new_authenticated_users: "New authenticated users",
  estimated_returning_authenticated_users: "Returning authenticated users",
