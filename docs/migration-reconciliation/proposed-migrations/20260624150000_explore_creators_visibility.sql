-- Show creators with ≥1 publication in zone (was 2) + global fallback for sparse areas.
...
CREATE OR REPLACE FUNCTION explore_trending_creators_global(
  filter_video_tag      TEXT           DEFAULT NULL,
  filter_place_category place_category DEFAULT NULL,
  max_results           INT            DEFAULT 10,
  offset_param          INT            DEFAULT 0,
...
GRANT EXECUTE ON FUNCTION explore_trending_creators_global(TEXT, place_category, INT, INT, TIMESTAMPTZ) TO anon, authenticated;
